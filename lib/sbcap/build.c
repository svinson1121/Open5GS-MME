...
// ogs_pkbuf_t *ogs_sbcap_build_error_indication(
//         S1AP_MME_UE_S1AP_ID_t *mme_ue_sbcap_id,
//         S1AP_ENB_UE_S1AP_ID_t *enb_ue_sbcap_id,
...
//         *MME_UE_S1AP_ID = *mme_ue_sbcap_id;
//         ogs_debug("    MME_UE_S1AP_ID[%d]", (int)*mme_ue_sbcap_id);
//     }
...
//         *ENB_UE_S1AP_ID = *enb_ue_sbcap_id;
//         ogs_debug("    ENB_UE_S1AP_ID[%d]", (int)*enb_ue_sbcap_id);
//     }
...
//     return ogs_sbcap_encode(&pdu);
// }

// ogs_pkbuf_t *ogs_sbcap_build_s1_reset(
//         S1AP_Cause_PR group, long cause,
...
// void ogs_sbcap_build_part_of_s1_interface(
//     S1AP_UE_associatedLogicalS1_ConnectionListRes_t **list,
//     uint32_t *mme_ue_sbcap_id,
//     uint32_t *enb_ue_sbcap_id)
// {
...
//     ogs_assert(list);
//     ogs_assert(mme_ue_sbcap_id || enb_ue_sbcap_id);
...
//         *item->mME_UE_S1AP_ID = *mme_ue_sbcap_id;
//     }

//     if (enb_ue_sbcap_id) {
//         item->eNB_UE_S1AP_ID = CALLOC(1, sizeof(*item->eNB_UE_S1AP_ID));
//         ogs_assert(item->eNB_UE_S1AP_ID);
//         *item->eNB_UE_S1AP_ID = *enb_ue_sbcap_id;
//     }
// }

// ogs_pkbuf_t *ogs_sbcap_build_s1_reset_ack(
//         S1AP_UE_associatedLogicalS1_ConnectionListRes_t *partOfS1_Interface)
// {
//     S1AP_S1AP_PDU_t pdu;
