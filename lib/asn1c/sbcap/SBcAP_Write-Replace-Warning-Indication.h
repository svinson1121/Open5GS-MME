...
#ifndef	_SBcAP_Write_Replace_Warning_Indication_H_
#define	_SBcAP_Write_Replace_Warning_Indication_H_
...
/* SBcAP_Write-Replace-Warning-Indication */
typedef struct SBcAP_Write_Replace_Warning_Indication {
	SBcAP_ProtocolIE_Container_86P4_t	 protocolIEs;
...
} SBcAP_Write_Replace_Warning_Indication_t;
...
#endif	/* _SBcAP_Write_Replace_Warning_Indication_H_ */
