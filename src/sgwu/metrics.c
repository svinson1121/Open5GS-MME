...
sgwu_metrics_spec_def_t sgwu_metrics_spec_def_global[_SGWU_METR_GLOB_MAX] = {
    ...
    [SGWU_METR_GLOB_GAUGE_GTP_OUTDATAOCTS1U] = {
        ...
        .name = "fivegs_servinggwfunction_sm_outdataocts1u",
    ...
    [SGWU_METR_GLOB_GAUGE_GTP_INDATAOCTS1U] = {
        .type = OGS_METRICS_METRIC_TYPE_GAUGE,
        .name = "fivegs_servinggwfunction_sm_indataocts1u",
    ...
    [SGWU_METR_GLOB_GAUGE_GTP_OUTDATAPACKETS1U] = {
        .type = OGS_METRICS_METRIC_TYPE_GAUGE,
        .name = "fivegs_servinggwfunction_sm_outpacketocts1u",
        .description = "Number of outgoing GTP data packets on the S1-U interface which have been generated by the GTP-U protocol entity on the S1-U interface",
    },
    [SGWU_METR_GLOB_GAUGE_GTP_INDATAPACKETS1U] = {
        .type = OGS_METRICS_METRIC_TYPE_GAUGE,
        .name = "fivegs_servinggwfunction_sm_inpacketocts1u",
        .description = "Number of incoming GTP data packets on the S1-U interface which have been accepted and processed by the GTP-U protocol entity on the S1-U interface.",
    },
